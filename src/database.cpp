...
namespace SQL_Module {
    ...
    class SQL_Result {
        ...
        SQL_Result(bool _success, std::vector<std::vector<SQL_Value>> _rows) : success(_success), rows(_rows) {}
        SQL_Result(bool _success) : success(_success), rows({}) {}
        SQL_Result() : success(false), rows({}) {}
    };
